...
#ifndef XLSX_XLSXCELLRANGE_H
#define XLSX_XLSXCELLRANGE_H
...
public:
    ...
    inline bool operator==(const CellRange& other) const { return top == other.top && bottom == other.bottom && left == other.left && right == other.right; }
    inline bool operator!=(const CellRange& other) const { return top != other.top || bottom != other.bottom || left != other.left || right != other.right; }
...
Q_DECLARE_TYPEINFO(xlsx::CellRange, Q_MOVABLE_TYPE);

#endif // XLSX_XLSXCELLRANGE_H
