...
#ifndef XLSX_XLSXDATAVALIDATION_H
#define XLSX_XLSXDATAVALIDATION_H
...
public:
    ...
    DataValidation();
    DataValidation(ValidationType type, ValidationOperator op = Between, const QString& formula1 = QString(), const QString& formula2 = QString(),
...
#endif // XLSX_XLSXDATAVALIDATION_H
